<div>
  ...
  <div class="min-h-full flex items-center justify-center p-3 sm:p-4">
    ...
    <div class="animate-fade-slide mt-[45px] w-full shadow-[0px_4px_4px_0px_#00000040] bg-gray-100  md:w-[600px] lg:w-[1100px] bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col lg:flex-row opacity-0 transform translate-y-10">
