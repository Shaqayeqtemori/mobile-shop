<div>
<div class="p-3 bg-gray-100 font-sans">

    <!--  کارت های آماری  -->
    <div class="grid grid-cols-1 sm:grid-cols-1  lg:grid-cols-4 gap-4 mb-4 p-5 ">
        <!-- کارت 1 -->
        <div class="bg-[#0B35CC]/10 rounded-2xl shadow-[0_4px_12px] p-4 border border-blue-200 ">
            <div class="flex justify-between items-center mb-1">
                <span class="text-sm text-gray-600 mb-6">  کل بردگی</span>
                <i class="bi bi-cash text-blue-600 text-xl mb-6 rounded-full bg-[#0B35CC]/40 w-8 h-8">
            ...
            <div class="flex justify-between items-center mb-1">
              ...
              <div class=""><p class=" text-[12px] text-blue-600  bg-[#0B35CC]/40 w-8">25%</p> </div>
            </div>
        </div>

        <!-- کارت 2 -->
        <div class="bg-[#0099FF]/10 rounded-2xl shadow-[0_4px_12px]  p-4 border border-purple-200 w-full max-w-full">
            <div class="flex justify-between items-center mb-1">
            ...
            <div class="flex justify-between items-center mb-1">
              ...
              <p class=" text-[12px] text-blue-500 bg-blue-300 w-8">25%</p>             
            </div>
        </div>

        <!-- کارت 3 -->
        <div class="bg-[#31009B]/10 rounded-2xl shadow-[0_4px_12px] p-4 border border-blue-200 w-full max-w-full">
            <div class="flex justify-between items-center mb-1">
            ...
            <div class="flex justify-between items-center mb-1">
              ...
              <p class=" text-[12px] text-blue-500 bg-[#31009B]/20 w-8 ">25%</p>         
            </div>
        </div>

        <!-- کارت 4 -->
        <div class="bg-[#3A64D0]/10 rounded-2xl shadow-[0_4px_12px] p-4 border border-indigo-200 w-full max-w-full">
            <div class="flex justify-between items-center mb-1">
            ...
            <div class="flex justify-between items-center mb-1">
              ...
              <p class=" text-[12px] text-blue-500 bg-[#3A64D0]/40 w-8">25%</p>             
            </div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-3 p-2">

    <!-- فرم -->
    <div class="bg-gray-100 rounded-2xl shadow-[0_4px_12px] shadow-lg border border-gray-200 w-full lg:max-w-full p-3">
        <div class="flex justify-between mb-2 shadow p-3 rounded-xl border border-[#0948EE]">
            <div class="flex gap-2 mt-3">
              ...
              <path d="M18.5459 4.66016C18.8659 5.79016 19.7459 6.67016 20.8659 6.98016" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <h2 class="text-bold text-[15px]">فورم ثبت قرضه</h2>
            </div>
            <div>
                <button class="bg-blue-700 p-3 gap-2 rounded-xl text-white flex">
        ...
        <select class="w-full rounded-xl border bg-gray-100 border-gray-900 p-4 text-sm mb-3">
        ...
        <textarea class="w-full rounded-xl border bg-gray-100 border-gray-900 p-2 text-sm h-28 mb-3" placeholder="توضیحات..."></textarea>
        ...
        <div class="flex justify-between mb-3">
            ...
            <div class="flex flex-col lg:flex-row gap-1">
                ...
                <div class="relative mb-1">
                    ...
                    <input type="text" class="p-1 pr-8 w-[100px] shadow border border-2 bg-[#0B35CC]/20 rounded-xl" placeholder="فیلتر">
                </div>
                <!-- جستجو -->
                <div class="relative mb-1">
                    <input type="text" class="p-1 w-[170px] shadow bg-[#0B35CC]/20 border border-2 rounded-xl" placeholder="جستجو....">
                    <span class="absolute left-1 top-1.5 text-gray-600">
            ...
            <table class="w-full text-center border-2 border-blue-300 text-sm border-collapse">
                <thead class="bg-blue-50 border-b-2 border-blue-300">
                    <tr>
