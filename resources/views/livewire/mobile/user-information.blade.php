...
<div class="bg-gray-100 font-sans text-gray-800 flex items-center justify-center p-3 sm:p-4">
  ...
  <!-- باکس اصلی سفید -->
  <div class="w-full md:w-[600px] mt-[45] shadow-[0px_4px_4px_0px_#00000040] bg-gray-100  lg:w-[1000px]  rounded-2xl shadow-lg flex flex-col lg:flex-row overflow-hidden">
...
<h2 class="text-[40px] sm:text-2xl mb-6 font-bold text-center lg:text-right flex items-center justify-center mt-[30px]">
    ...
    <div class="flex-1 lg:w-1/12 flex items-center justify-center p-4 sm:p-5 order-2 lg:order-2">
      <div class="w-full max-w-[400px] rounded-2xl overflow-hidden">
