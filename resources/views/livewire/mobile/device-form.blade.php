<div>
<div class="bg-gray-100 font-sans text-gray-800 overflow-hidden">

  <div class="min-h-full flex items-center justify-center p-3 sm:p-4">
    
    <!-- باکس اصلی سفید با انیمیشن -->
    <div class="animate-fade-slide mt-[45px] shadow-[0px_4px_4px_0px_#00000040] w-full md:w-[600px] lg:w-[1100px] bg-gray-100 rounded-2xl shadow-xl overflow-hidden flex flex-col lg:flex-row opacity-0 transform translate-y-10">
        ...
        <div class="w-full max-w-md">
          ...
          <div class="flex items-center justify-center mb-[30px] gap-10 sm:gap-20 animate-fade-in delay-300">
            <div class="flex items-center justify-between relative w-full">
              ...
              <!-- مراحل -->
              <div class="flex flex-col items-center relative z-10 bg-gray-100">
          ...
          <form action="" class="space-y-8">
            ...
            <div class="flex flex-col sm:flex-row sm:mt-6 justify-between mt-6 gap-4 animate-fade-in delay-500">
              <a class="w-full sm:w-[48%] py-3 rounded-xl bg-[#FF0000] text-white text-base font-semibold text-center hover:scale-105 transition-all duration-300">
                برگشت
              </a>
      ...
      <div class="flex-1 lg:w-5/12 flex items-center justify-center p-5 sm:p-5 order-2 lg:order-1   mt-6 lg:mt-0 animate-fade-in delay-400">
        <div class="w-full max-w-[400px]">
          <img src="https://i.postimg.cc/CMnYr98x/download-(2).png" alt="Success Illustration"
               class="w-full h-auto object-cover rounded-2xl  hover:scale-105 transition-transform duration-500">
        </div>
      </div>
